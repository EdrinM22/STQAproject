...
import main.java.BookstoreData.Book;
import main.java.BookstoreData.BookData;
...
import main.java.Staff.Worker.ACCESSLEVEL;
import main.java.StyleControllers.MainController;
...
public class MainPage{
    ...
    private void createMainPage() throws FileNotFoundException {
        ...
        if(worker.getGender().equals(Gender.FEMALE)){
            profileImage = new Image(new FileInputStream("src\\Images\\main\\java\\Woman.png"));
        }else{
            profileImage = new Image(new FileInputStream("src\\Images\\main\\java\\Man.png"));
        }
